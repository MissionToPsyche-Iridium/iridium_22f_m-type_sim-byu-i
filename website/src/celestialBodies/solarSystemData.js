...
export class SolarSystemData {
    ...
    static dataSet = Object.freeze({
        sun: { type: "star", orbit: "self", meanRadius: 696340, semiMajAxis: 0.00000000, ecc: 0.00000000, incl: 0.00000000, longAscNode: 0.0000000, argPeri: 0.0000000, mean: 0.000000, mass: 1.989e30, rot: 1.66e-4, tilt: 0.00 },
        mercury: { type: "planet", orbit: "sun", meanRadius: 2439.7, semiMajAxis: 0.38709927, ecc: 0.20563593, incl: 7.00497902, longAscNode: 48.3307659, argPeri: 77.4577963, mean: 252.250324, mass: 3.301e23, rot: 7.11e-5, tilt: 0.03 },
        venus: { type: "planet", orbit: "sun", meanRadius: 6051.8, semiMajAxis: 0.72333199, ecc: 0.00677255, incl: 3.39467605, longAscNode: 76.6799207, argPeri: 131.5329800, mean: 181.979099, mass: 4.867e24, rot: -1.71e-5, tilt: 177.40 },
        earth: { type: "planet", orbit: "sun", meanRadius: 6371, semiMajAxis: 1.00000011, ecc: 0.01671123, incl: 0.00004700, longAscNode: 174.8731400, argPeri: 102.9471900, mean: 100.464350, mass: 5.972e24, rot: 4.17e-3, tilt: 23.44 },
        mars: { type: "planet", orbit: "sun", meanRadius: 3389.5, semiMajAxis: 1.52366231, ecc: 0.09341233, incl: 1.84969142, longAscNode: 49.5580930, argPeri: 336.0408400, mean: 355.453320, mass: 6.417e23, rot: 4.06e-3, tilt: 25.19 },
        jupiter: { type: "planet", orbit: "sun", meanRadius: 69911, semiMajAxis: 5.20260318, ecc: 0.04838624, incl: 1.30327094, longAscNode: 100.5561500, argPeri: 14.7538500, mean: 34.404380, mass: 1.899e27, rot: 1.01e-2, tilt: 3.13 },
        saturn: { type: "planet", orbit: "sun", meanRadius: 58232, semiMajAxis: 9.55490900, ecc: 0.05554623, incl: 2.48446000, longAscNode: 113.7150400, argPeri: 92.8766900, mean: 50.067940, mass: 5.685e26, rot: 9.34e-3, tilt: 26.73 },
        uranus: { type: "planet", orbit: "sun", meanRadius: 25362, semiMajAxis: 19.2184100, ecc: 0.04638171, incl: 0.77213783, longAscNode: 74.2298800, argPeri: 170.9642000, mean: 314.055420, mass: 8.681e25, rot: -5.79e-3, tilt: 97.77 },
        neptune: { type: "planet", orbit: "sun", meanRadius: 24622, semiMajAxis: 30.1104000, ecc: 0.00858587, incl: 1.76917000, longAscNode: 131.7216900, argPeri: 44.9648000, mean: 304.348220, mass: 1.024e26, rot: 6.19e-3, tilt: 28.32 },
        psycheAsteroid: { type: "asteroid", orbit: "sun", meanRadius: 112.5, semiMajAxis: 2.92270000, ecc: 0.14000000, incl: 3.10000000, longAscNode: 150.8200000, argPeri: 228.2100000, mean: 53.036000, mass: 2.720e19, rot: 2.39e-2, tilt: 85.00 },
    ...
    static verifyObjectExists(objectName) {
        if (SolarSystemData.dataSet.hasOwnProperty(objectName)) {
            return true;
        } else {
    ...
    static getCelestialProfile(celestialName){
        const data = SolarSystemData.dataSet[celestialName];
        return {
...
export class CelestialLocations {
    ...
    static getAbsolute(date, bodyName) {
        // console.log("Body Name is " + bodyName);
        if (bodyName === 'sun') {
