...
const Tower = ({position, scaleFactor}) => {
    const objectName = "tower";
    const objPath = '/iridium_22f_m-type_sim-byu-i/assets/meshes/locations/launchPad49a/tower.obj'
    ...
    const material = new THREE.MeshStandardMaterial({ color: 'rgb(15, 15, 15)'});
