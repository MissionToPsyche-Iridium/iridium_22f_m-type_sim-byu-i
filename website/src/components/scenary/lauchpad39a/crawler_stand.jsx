...
const CrawlerStand = ({position, scaleFactor}) => {
    const objectName = "crawlerstand";
    const objPath = '/iridium_22f_m-type_sim-byu-i/assets/meshes/locations/launchPad49a/crawler_stand.obj'
    ...
    const material = new THREE.MeshStandardMaterial({ color: 'rgb(202, 212, 155)'});
