...
import { SolarSystemData, CelestialLocations } from '../src/celestialBodies/solarSystemData.js';
...
test('TEST 01 - Verify getAbsolutePosition returns valid Vector3 for x all items', () => {
...
test('TEST 03 - Verify that getRelativePosition signs are opposite when sun is relative to planet', () => {
  ...
  let x = marsAbs.x + sunRelMars.x;
  let y = marsAbs.y + sunRelMars.y;
  let z = marsAbs.z + sunRelMars.z;
